...
The basic ingredient is the _so called_ learnable activation $\phi_{l,j,i}$ which maps the post-activation of $i$th neuron in layer $l$ to the pre-activation of $j$th neuron. Effectively, it is the edge connecting two neurons on  adjacent layers. But how can it be made learnable? Represent this activation function as:
$$
\begin{align}
